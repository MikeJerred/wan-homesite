...
@Component({
    ...
    template: `
<app-blog title="The UX of Conversation Part 2" duration="Project duration: 10th October - 19th October, 2018" team="Team: Coco Li, Elaine Zhang, Wan Li, Yuhan Mao" [previous]="{ name: 'The UX of Conversation Part 1', link: ['/blog', 2], extend: 300 }" [next]="{ name: 'The UX of Conversation Part 3', link: ['/blog', 4], extend: 300 }">
    <div class="col-12">
