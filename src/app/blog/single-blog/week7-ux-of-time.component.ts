...
@Component({
    ...
    template: `
<app-blog title="The UX of Time Part 1" duration="Project duration: 5th November - 16th November, 2018" team="Team: Constance Ip, Daniela Navaes, Deepika Grover, Nat Di Pasquale, Wan Li" [previous]="{ name: 'The UX of Urban Space Part 2', link: ['/blog', 6], extend: 300 }" [next]="{ name: 'The UX of Time Part 2', link: ['/blog', 8], extend: 230 }">
