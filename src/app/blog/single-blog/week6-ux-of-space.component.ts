...
@Component({
    ...
    template: `
<app-blog
    title="The UX of Urban Space Part 2"
    duration="Project duration: 22nd October - 2nd November, 2018"
    team="Team: George Darbyshire, Ivy Wong, Wan Li, Patrick Bull, Yuhan Mao"
    [previous]="{ name: 'foo', link: ['/blog', 5] }"
    [next]="null"
>
