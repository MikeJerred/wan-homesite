...
@Component({
    ...
    template: `
<app-blog title="The UX of Conversation Part 3" duration="Project duration: 10th October - 19th October, 2018" team="Team: Coco Li, Elaine Zhang, Wan Li, Yuhan Mao" [previous]="{ name: 'The UX of Conversation Part 2', link: ['/blog', 3], extend: 270 }" [next]="{ name: 'The UX of Urban Space Part 1', link: ['/blog', 5], extend: 270 }">
    <div class="col-12">
